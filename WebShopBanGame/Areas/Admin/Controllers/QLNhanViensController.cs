...
namespace WebShopBanGame.Areas.Admin.Controllers
{
    public class QLNhanViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNV,TenNV,SDT,Email,DiaChi,Avatar,TenDN,MK,PhanQuyen")] NHANVIEN nHANVIEN)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNV,TenNV,SDT,Email,DiaChi,Avatar,TenDN,MK,PhanQuyen")] NHANVIEN nHANVIEN)
        {
            if (ModelState.IsValid)
            {
